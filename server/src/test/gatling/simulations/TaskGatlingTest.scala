...
class TaskGatlingTest extends Simulation {
    ...
    val headers_http = Map(
        ...
        val authorization_header = "Basic " + Base64.getEncoder.encodeToString("serverapp:mySecretOAuthSecret".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .put("/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "completed":null}""")).asJSON
            .check(status.is(201))
